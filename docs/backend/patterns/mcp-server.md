...
└── AddListToolsFilter  ← Hides disabled-module tools from listing
       │
[McpServerToolType] classes   ← 28 tools across 12 domains
[McpServerResourceType] classes ← 5 resources (schema + entity)
[McpServerPromptType] classes   ← 5 prompt templates
```
