...
public class LayerDependencyTests
{
    ...
    public void Application_Core_ShouldNotDependOn_EntityFrameworkCore()
    {
        ...
        var result = Types
            ...
            .And()
            .DoNotResideInNamespace("NOIR.Application.Features.Hr.Commands.AssignTagsToEmployee")
            .And()
            .DoNotResideInNamespace("NOIR.Application.Features.Hr.Commands.RemoveTagsFromEmployee")
            .And()
            .DoNotResideInNamespace("NOIR.Application.Features.Hr.Commands.DeleteTag")
            .And()
            ...
            .And()
            .DoNotResideInNamespace("NOIR.Application.Features.Crm.Commands.CreateStage")
            .And()
            .DoNotResideInNamespace("NOIR.Application.Features.Crm.Commands.DeleteStage")
            .And()
            .DoNotResideInNamespace("NOIR.Application.Features.Crm.Commands.MoveLeadStage")
            .And()
            .DoNotResideInNamespace("NOIR.Application.Features.Crm.Commands.ReorderStages")
            .And()
            .DoNotResideInNamespace("NOIR.Application.Features.Crm.Commands.UpdateStage")
            .And()
            .DoNotResideInNamespace("NOIR.Application.Features.Pm")
            .ShouldNot()
            .HaveDependencyOn("Microsoft.EntityFrameworkCore")
            .GetResult();
