...
/// <summary>
/// Unit tests for DeleteBrandCommandValidator.
/// Tests all validation rules for deleting a brand.
/// </summary>
public class DeleteBrandCommandValidatorTests
{
    ...
    {
        // Arrange
        var command = new DeleteBrandCommand(Id: Guid.Empty);
    ...
    {
        // Arrange
        var command = new DeleteBrandCommand(Id: Guid.NewGuid(), BrandName: "Nike");
