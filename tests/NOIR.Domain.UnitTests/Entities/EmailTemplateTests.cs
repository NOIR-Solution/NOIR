...
public class EmailTemplateTests
{
    ...
    public void Create_WithRequiredParameters_ShouldCreateValidTemplate()
    {
        ...
        // Act
        var template = EmailTemplate.Create(name, subject, htmlBody);
    ...
    {
        // Act
        var template = EmailTemplate.Create("Test", "Subject", "<p>Body</p>");
    ...
    {
        // Arrange
        var template = EmailTemplate.Create("Test", "Old Subject", "<p>Old</p>");
    ...
    [Fact]
    public void Create_WithTemplateVariablesInSubject_ShouldPreserveVariables()
    {
        // Arrange
        var subject = "Hello {{UserName}}, your order #{{OrderId}} is ready";

        // Act
        var template = EmailTemplate.Create("OrderReady", subject, "<p>Body</p>");
    ...
    [Fact]
    public void Create_WithTemplateVariablesInHtmlBody_ShouldPreserveVariables()
    {
        // Arrange
        var htmlBody = "<p>Hello {{UserName}},</p><p>Your OTP is: {{OtpCode}}</p>";

        // Act
        var template = EmailTemplate.Create("OtpEmail", "Your OTP", htmlBody);
    ...
    public void Create_WithTenantId_ShouldBeAssociatedWithTenant()
    {
        ...
        // Act
        var template = EmailTemplate.Create("Test", "Subject", "<p>Body</p>", tenantId: tenantId);
    ...
    [Fact]
    public void Create_WithoutTenantId_ShouldBeGlobalTemplate()
    {
        // Act
        var template = EmailTemplate.Create("Test", "Subject", "<p>Body</p>");
