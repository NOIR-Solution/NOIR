...
/**
 * TermsPage - Page Object for the public Terms of Service page (/terms)
 *
 * This page displays the Terms of Service content fetched from the API.
 * It includes navigation back to the landing page and links to the Privacy page.
 */
export class TermsPage extends BasePage {
  ...
  /**
   * Verify the Terms page has loaded correctly with content
   */
