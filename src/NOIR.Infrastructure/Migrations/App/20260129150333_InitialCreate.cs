        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CorrelationId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    RequestData = table.Column<string>(type: "nvarchar(max)", maxLength: 10500, nullable: true),
                    ResponseData = table.Column<string>(type: "nvarchar(max)", maxLength: 10500, nullable: true),
                    HttpStatusCode = table.Column<int>(type: "int", nullable: true),
                    DurationMs = table.Column<long>(type: "bigint", nullable: false),
                    Success = table.Column<bool>(type: "bit", nullable: false),
                    ErrorCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ErrorMessage = table.Column<string>(type: "nvarchar(2100)", maxLength: 2100, nullable: true),
                    StackTrace = table.Column<string>(type: "nvarchar(max)", maxLength: 4100, nullable: true),
                    AdditionalContext = table.Column<string>(type: "nvarchar(max)", maxLength: 4100, nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentOperationLogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestBody = table.Column<string>(type: "nvarchar(max)", maxLength: 500, nullable: false),
                    RequestHeaders = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    SignatureValue = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GatewayFee = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    ...
                    PayerInfo = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ...
                    GatewayResponseJson = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentInstallments_PaymentTransactions_PaymentTransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Carts_TenantId_Status",
                table: "Carts",
                columns: new[] { "TenantId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Carts_TenantId_Status_LastActivity",
                table: "Carts",
                columns: new[] { "TenantId", "Status", "LastActivityAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentInstallments_Status_DueDate",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentInstallments_TransactionId",
                table: "PaymentInstallments",
                column: "PaymentTransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentOperationLogs_TenantId_CorrelationId",
                table: "PaymentOperationLogs",
                columns: new[] { "TenantId", "CorrelationId" });

            migrationBuilder.CreateIndex(
                name: "IX_PaymentOperationLogs_TenantId_CreatedAt",
                table: "PaymentOperationLogs",
                columns: new[] { "TenantId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_PaymentOperationLogs_TenantId_Provider_OperationType",
                table: "PaymentOperationLogs",
                columns: new[] { "TenantId", "Provider", "OperationType" });

            migrationBuilder.CreateIndex(
                name: "IX_PaymentOperationLogs_TenantId_Success_CreatedAt",
                table: "PaymentOperationLogs",
                columns: new[] { "TenantId", "Success", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_PaymentOperationLogs_TenantId_TransactionId",
                table: "PaymentOperationLogs",
                columns: new[] { "TenantId", "PaymentTransactionId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategories_TenantId_Parent_Sort",
                table: "ProductCategories",
                columns: new[] { "TenantId", "ParentId", "SortOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_ProductCategories_TenantId_Slug",
                table: "ProductCategories",
                columns: new[] { "TenantId", "Slug" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Products",
                columns: new[] { "TenantId", "BasePrice" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_TenantId_InStock",
                table: "ProductVariants",
