...
namespace NOIR.Infrastructure.Migrations.App
{
    ...
    [Migration("20260319080733_CRM_PipelineStage_AddStageTypeAndIsSystem")]
    partial class CRM_PipelineStage_AddStageTypeAndIsSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.ApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("SecretSuffix")
                        .IsRequired()
                        .HasMaxLength(10)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Crm.CrmActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ContactId", "LeadId", "TenantId")
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Crm.CrmCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Crm.CrmContact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Crm.Lead", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PipelineId", "StageId", "Status", "TenantId")
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Crm.Pipeline", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Crm.PipelineStage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("Name", "PipelineId", "TenantId")
                        .IsUnique()
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Hr.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Hr.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "Status", "DepartmentId")
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Hr.EmployeeTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Hr.EmployeeTagAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("EmployeeTagId");

                    b.HasIndex("TenantId");

                    b.HasIndex("TenantId", "EmployeeId", "EmployeeTagId")
                        .IsUnique()
                        .HasDatabaseName("IX_EmployeeTagAssignments_TenantId_Employee_Tag");

                    b.ToTable("EmployeeTagAssignments", (string)null);
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Pm.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Pm.ProjectColumn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Pm.ProjectMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProjectId", "EmployeeId", "TenantId")
                        .IsUnique()
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Pm.ProjectTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TaskNumber", "TenantId")
                        .IsUnique()
                        .HasDatabaseName("IX_ProjectTasks_TaskNumber_TenantId");

                    b.HasIndex("ProjectId", "ColumnId", "Status", "TenantId")
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Pm.ProjectTaskLabel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TaskId", "LabelId", "TenantId")
                        .IsUnique()
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Pm.TaskComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Pm.TaskLabel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProjectId", "Name", "TenantId")
                        .IsUnique()
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Crm.CrmActivity", b =>
                {
                    b.HasOne("NOIR.Domain.Entities.Crm.CrmContact", "Contact")
                        .WithMany()
                        .HasForeignKey("ContactId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("NOIR.Domain.Entities.Crm.Lead", "Lead")
                        .WithMany()
                        .HasForeignKey("LeadId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("NOIR.Domain.Entities.Hr.Employee", "PerformedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Crm.CrmCompany", b =>
                {
                    b.HasOne("NOIR.Domain.Entities.Hr.Employee", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Crm.CrmContact", b =>
                {
                    b.HasOne("NOIR.Domain.Entities.Crm.CrmCompany", "Company")
                        .WithMany("Contacts")
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Crm.Lead", b =>
                {
                    ...
                    b.HasOne("NOIR.Domain.Entities.Crm.Pipeline", "Pipeline")
                        .WithMany()
                        .HasForeignKey("PipelineId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("NOIR.Domain.Entities.Crm.PipelineStage", "Stage")
                        .WithMany()
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Hr.Department", b =>
                {
                    b.HasOne("NOIR.Domain.Entities.Hr.Employee", "Manager")
                        .WithMany()
                        .HasForeignKey("ManagerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("NOIR.Domain.Entities.Hr.Department", "ParentDepartment")
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Hr.Employee", b =>
                {
                    b.HasOne("NOIR.Domain.Entities.Hr.Department", "Department")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Hr.EmployeeTagAssignment", b =>
                {
                    b.HasOne("NOIR.Domain.Entities.Hr.Employee", "Employee")
                        .WithMany("TagAssignments")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("NOIR.Domain.Entities.Hr.EmployeeTag", "EmployeeTag")
                        .WithMany("TagAssignments")
                        .HasForeignKey("EmployeeTagId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Employee");

                    b.Navigation("EmployeeTag");
                });
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Pm.ProjectColumn", b =>
                {
                    b.HasOne("NOIR.Domain.Entities.Pm.Project", "Project")
                        .WithMany("Columns")
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Pm.ProjectTask", b =>
                {
                    b.HasOne("NOIR.Domain.Entities.Hr.Employee", "Assignee")
                        .WithMany()
                        .HasForeignKey("AssigneeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("NOIR.Domain.Entities.Pm.ProjectColumn", "Column")
                        .WithMany("Tasks")
                        .HasForeignKey("ColumnId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("NOIR.Domain.Entities.Pm.ProjectTask", "ParentTask")
                        .WithMany("SubTasks")
                    ...
                    b.HasOne("NOIR.Domain.Entities.Hr.Employee", "Reporter")
                        .WithMany()
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Pm.ProjectTaskLabel", b =>
                {
                    b.HasOne("NOIR.Domain.Entities.Pm.TaskLabel", "Label")
                        .WithMany()
                        .HasForeignKey("LabelId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("NOIR.Domain.Entities.Pm.ProjectTask", "Task")
                        .WithMany("TaskLabels")
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.Pm.TaskComment", b =>
                {
                    b.HasOne("NOIR.Domain.Entities.Hr.Employee", "Author")
                        .WithMany()
