...
namespace NOIR.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260118115507_AddMediaFileEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.TenantBranding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.TenantDomain", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.UserTenantMembership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.TenantBranding", b =>
                {
                    b.HasOne("NOIR.Domain.Entities.Tenant", null)
                        .WithOne("Branding")
                        .HasForeignKey("NOIR.Domain.Entities.TenantBranding", "TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("NOIR.Domain.Entities.UserTenantMembership", b =>
                {
                    b.HasOne("NOIR.Domain.Entities.Tenant", "Tenant")
